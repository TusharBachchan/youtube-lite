...
const SideBar = () => {
  ...
  if(sideBarClosed) return null;
    ...
    return (
      <div className="w-full bg-white pr-5 overflow-auto pb-8 sidebar mobile:mt-48 sm:mt-28 md:mt-36">
  ...
  return <button className="p-3 border mx-2 bg-gray-200 rounded-full text-gray-900 "><SlOptions /></button>
}
